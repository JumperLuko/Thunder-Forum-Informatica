...
CREATE TABLE `post` (
  ...
  CONSTRAINT `fk_post_2` FOREIGN KEY (`post_id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_post_1` FOREIGN KEY (`post_id_category_post`) REFERENCES `category_post` (`idcategory_post`) ON DELETE NO ACTION ON UPDATE NO ACTION
