...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_user_1` FOREIGN KEY (`user_id_class_user`) REFERENCES `class_user` (`id_class_user`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_category` FOREIGN KEY (`user_id_category_user`) REFERENCES `category_user` (`idcategory_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
