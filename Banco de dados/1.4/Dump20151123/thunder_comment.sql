...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `fk_comment_2` FOREIGN KEY (`comment_id_post`) REFERENCES `post` (`id_post`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_comment_1` FOREIGN KEY (`comment_id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
