...
<?php
    ...
    echo('<div class="content_question"><a href="perguntas-aberto.php?codigo='.$linha["id_post"].'"><div class="article"><div class="title">Quest'.$linha["id_post"].'</div><div class="text"><p>'.$linha["content"].'</p></div></div><div class="margin-bottom"></div></a></div>');
    }
?>
