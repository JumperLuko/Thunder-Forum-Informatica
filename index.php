...
"><div class="border-li"><a class="select" href="index.php">HOME</a></div></li>
        ...
        <?php
            if(isset($_SESSION["id"])){
                echo('
                <li class="border_menu"><a class="no_select" href="html/criar_perguntas.php">CRIAR  PERGUNTAS</a></li>
                ');
            }else{
                echo('
                <li class="border_menu"><a class="no_select" href="html/cadastro.php">CADASTRO</a></li>
                ');
            }
        ?>
            ...
            <?php
                ...
                if(isset($_SESSION["id"])){
                    ...
                    <form>
                        ...
                        <li>
                            <label>Nickname: '.$id["nickname"].'</label>
                        </li>
                        <li>
