...
CREATE TABLE `thunder`.`category_post` (
...
CREATE TABLE `thunder`.`category_user` (
...
CREATE TABLE `thunder`.`class_user` (
...
CREATE TABLE `thunder`.`denouncement` (
...
CREATE TABLE `thunder`.`valuation` (
